...
│
├── 📂 data_input/                      # (User Provided)
│   ├── Original database-FGA.xlsx      # Raw DFT/AIMD calculation results
│   ├── prediction-FGA-Eb.xlsx          # Candidates for Wettability prediction
│   └── prediction-FGA-NVOA.xlsx        # Candidates for Heat Transport prediction
│
├── 📂 feature_engineering_output/      # (Auto-Generated by Step 1)
│   ├── Final_engineered_dataset-Eb.xlsx
│   ├── Final_engineered_dataset-NVOA.xlsx
│   └── ... (Correlation matrices & Logs)
│
├── 📂 results/                         # (Auto-Generated by Step 2 & 3)
│   ├── SHAP_Analysis_Results.xlsx      # Global feature importance & evaluation metrics
│   └── unknown_predictions_timestamp.xlsx
│
